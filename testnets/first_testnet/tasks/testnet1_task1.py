...
from testnets.first_testnet.testnet_data.testnet1_variables import testnet1_task1_url
from tools.tools import check_stuck_wallet_window
from tools.wallet_extension import wallet_operations


async def testnet1_task1(ads_profile: Profile, page: Page) -> bool:
